...
//        var bottom_html = "<input type='file' id='fileInput' name='files[]'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
        var bottom_html = "<input type='file' id='fileInput' name='profile_image'/ accept='image/*'><canvas id='myCanvas' style='display:none;'></canvas><div id='modal'></div><div id='preview'><div class='buttons'><div class='cancel'></div><div class='ok'></div></div></div>";
        ...
        function preview() {
            ...
            var hdnimageFoo = document.createElement('input');
            hdnimageFoo.type = 'text';
            hdnimageFoo.style = 'display:none;';
            hdnimageFoo.value = dataUrl;
            hdnimageFoo.id = 'hdnimgCrop';
            hdnimageFoo.name = 'hdnimgCrop';
            ...
            file_display_area.append(hdnimageFoo);
